    ...
    <script>
      $(document).ready(function () {
        ...
        var salesNonSales = {
            ...
            data: [{
                ...
                indexLabelFontColor: "#ffffff",
                dataPoints: [
                    { y: ${fn:length(designation.sales)}, name: "Designation 1", color: "#F97D58", indexLabel: "${fn:length(designation.sales)}", indexLabelFontColor: "#FFF" },
      ...
      var options = {
        ...
        var options = {
          series: [{
          name: 'Action Points',
          data: [${fn:length(action.interviewStatus)},${fn:length(action.assessmentStatus)}, ${fn:length(action.documentUploadStatus)},${fn:length(action.fsdmApproval)}]
        }],
          chart: {
          type: 'bar',
          height: 300
        ...
        xaxis: {
          categories: ['Interview', 'Assessments', 'Documents', 'Approval'],
        },
        fill: {
          opacity: 1
        },
