...
<html lang="en">
                    ...
                    <c:forEach items="${participantList}" var="participant">
                        <tr>
							...
							<c:choose>
                             ...
                             <td><a href="#" class="view-btn #DC3545" onclick="approveParticipant('${participant.accesskey}')">Approve</a></td>  
                        </tr>
                        <%i++; %>
                        </c:forEach>
                    </tbody>
 ...
 $(document).ready(function () {
	  var form = $('#formFilter');
	  form.attr('action', 'viewAllCompletedParticipant');
 });
 
 	function approveParticipant(accesskey){
 		//alert(accesskey);
 		$.ajax({
 			type: 'POST',
 			url: 'approveParticipant',
      ...
      function openProfile(key){
       ...
       function funexport() {
 			...
 			var dateTo =$('#dateToo').val();
       	    ...
       	    form.method="post";
       		form.action="csvPendingApproval?dateFromm="+dateFrom+"&dateToo="+dateTo;
