...
#find-button {        width: 50px;       	height: 40px;    }
</style>
</head>
<body>
	...
	<div class="right-section">
		...
		<div class="div-button" style="display: flex;">
			<button class="btn btn-primary" id="pass-btn">Pass Participant</button>
		...
		<br>
		<div id="pass-page" style="display: none;">
		...
		<div id="find-page" style="display: none;">
		...
		<div id="error-page" style="display: none;" class="table-date">
	...
	<script>
		$(document).ready(function() {
			...
			$("#error-logger-btn").click(function(){
				$("#error-page").show();
				$("#find-page").hide();
				$("#pass-page").hide();
