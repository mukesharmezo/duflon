			...
			<div class="add-remove-columns">
                    ...
                    <ul>
                      ...
                      <!--  <li><a class="toggle-vis" data-column="10"><em>Total Marks</em></a></li>
						...
						<li><a class="toggle-vis" data-column="14"><em>Assessment Sheet</em></a></li>
                    ...
                    <thead>
                        <tr>
                          ...
                          <!--  <th data-head="Total Marks" class="sorting"><em>Total Marks</em></th>
                            ...
                            <th data-head="Praarambh Status" class="sorting"><em>Prarambh Status</em></th>
               ...
               <c:when test="${participant.designation eq 'Sales Support'}">
                           ...
                           <!--  <td>
							 <span class="green">${participant.prarambhStatus }</span>
							 </td> -->
							 <td>
							  <c:choose>
