		  ...
		  disableCheck();
        	...
        	if(clarity_1 !="" && presentability_1 != "" && attitude_1 != "" && situation_1 != "" && name_1 !="" && designation_1 != "" && mobile_1 !=""  && intvCount ==1){
				...
				$('#pass_fail_status').show();  
           	 	$("#total-marks").show();
           	 	$("#averageScore").show();
        	}else if(clarity_1 !="" && presentability_1 != "" && attitude_1 != "" && situation_1 != "" && name_1 !="" && designation_1 != "" && mobile_1 !=""  && 
        	  clarity_2 !="" && presentability_2 != "" && attitude_2 != "" && situation_2 != "" && name_2 !="" && designation_2 != "" && mobile_2 !="" && intvCount == 2){
        		$('#btn_submit').show(); 
				$('#pass_fail_status').show();  
           	 	$("#total-marks").show();
        	  ...
        	  clarity_3 !="" && presentability_3 != "" && attitude_3 != "" && situation_3 != "" && name_3 !="" && designation_3 != "" && mobile_3 !="" && intvCount == 3)
        	 {
        		 $('#btn_submit').show(); 
				 $('#pass_fail_status').show();  
            	 $("#total-marks").show();
