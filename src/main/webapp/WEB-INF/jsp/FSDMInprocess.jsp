...
s.removeAttribute("fsdm_approvel");
  ...
  <body>
    ...
    <div class="user-panel-include">
      <%@include file="./header/user-panel.jsp"%>
        ...
        <div class="page-filter-include">
		  <%@include file="./filter/searchFSDM.jsp"%>
		</div>
    ...
    <script>
      ...
      function openReport(key,name,email,mobile){
	        mywindow=window.open("https://staging.irecruit.org.in/sg_iRecruit/player/viewAssessment.jsp?accesskey="+key+"&name="+name+"&email="+email+"&mobile="+mobile+"&testid=41&attemptid=1","detailwindow","resizable=1,scrollbars=1,width=1170,height=600");
	       mywindow.moveTo(120,90);
     }
      ...
      function funexport()
  	{
		...
		var dateTo =$('#dateToo').val();
  		 document.forms[0].action="./inProgressCSV?outletCode="+outlet+"&candidate="+name+"&unique="+uniqueCode+"&desig="+desg+"&mspinS="+mspinS+"&pass="+passFail+"&dateFromm="+dateFrom+"&dateToo="+dateTo;
  		document.forms[0].method="post";
  		document.forms[0].submit();
  	}
          </script>
