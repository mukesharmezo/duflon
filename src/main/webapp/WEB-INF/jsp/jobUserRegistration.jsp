...
<body>
    ...
    <div class="form-block col-md-12" style="padding-right: 56px;padding-left:0px;">
        ...
        <!-- <button type="button" class="btn btn-remove btn-sm btn-success" id="addSkillBtn"> + </button> -->
		  ...
		  function addSkillRow() {
		    ...
		    newRow.append($('<td>')
		      ...
		      .append($('<td>')
		        .append($('<button>')
		          .attr('type', 'button')
		        //   .addClass('btn btn-danger btn-circle rounded-circle')
