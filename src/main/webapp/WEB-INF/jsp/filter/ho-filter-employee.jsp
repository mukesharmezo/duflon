            ...
            <form action="hoFilterEmployee" method="post"  class="form-section"  id="formFilter">
                ...
                <div class="form-block">
                    ...
                    <c:forEach items="${dealerCodeList}" var="list">
                        <option value="${list.outletName}"  <c:if test="${payload.dealershipCode eq list.outletName}"> selected</c:if>>${list.outletName}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-block">
    ...
    function cityChange(){
	 ...
	 $.ajax({
		 ...
		 success:function(response){
             ...
             $("#outletCode").empty().append("<option value=''>Dealer Code</option>");
		 },
		 error:function(resp){
		 }
	 });
	...
	function stateChange(){
		 ...
		 $.ajax({
			 ...
			 success:function(response){
				 ...
				 $("#dealershipName").empty().append("<option value=''>Dealership</option>");
				 $("#outletCode").empty().append("<option value=''>Dealer Code</option>");
			 },
			 error:function(resp){
			 }
