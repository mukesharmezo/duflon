...
<div class="page-filters">
    <div class="page-filters-block">
        ...
        <div class="page-filters-filter-block">
            ...
            <form action="filterParticipantOnFSDMHold" method="post" class="form-section" id="formFilter" >
    ...
    <div class="page-filters-block">
        ...
        <div class="page-filters-process-block">
            ...
            <form action="statusFSDMHold" method="post" class="form-section">
                ...
                <div class="form-block">
                   <input type="checkbox" id="status" name="fsdm"   id="fsdm" value="fsdm" /><label for="fsdm">FSDM Remark</label>
                </div>
                <div class="form-button">
                    <!-- <button class="cancel-btn">Cancel</button> -->
