...
<style>
        ...
        .cross-btn {cursor: pointer;border-radius: 5px;margin-bottom: 10px;margin-left: 95%;top: 0;font-size: 20px;background-color: #fff !important;color: #DC3545 !important;border: 1px solid #DC3545 !important;    position: absolute;top: 8px;right: 8px;}
    </style>
