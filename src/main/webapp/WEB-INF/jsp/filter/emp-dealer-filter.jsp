...
<div class="page-filters">
    <div class="page-filters-block">
        ...
        <div class="page-filters-filter-block">
            ...
            <form action="filterMasterParticipant" method="post" class="form-section" id="formFilter" >
                ...
                <div class="form-block">
                    <input type="text" name="mspin" placeholder="MSPIN" id="mspinS"  value="${payload.mspin}"/>
                </div>
                <div class="form-block">
