...
<div class="page-filters">
    <div class="page-filters-block">
        ...
        <div class="page-filters-filter-block">
            ...
            <form action="holdFilterParticipant" method="post" class="form-section" id="formFilter" >
                ...
                <div class="form-button">
                    ...
                    <input  type="button" class="submit-btn" onclick=" search()" value="Submit">
                </div>
    ...
    <div class="page-filters-block">
        ...
        <div class="page-filters-process-block">
            ...
            <form action="completionStatusHold" method="post" class="form-section">
