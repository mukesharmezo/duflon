...
{ 
	...
	if(filename.substring((filename.length-5),filename.length)!=".xlsx")
	{
		...
		document.uploadfile.action="uploadPrarentDealerPro";
	...
	<div class="container">
		...
		<div class="table-wrap">
			...
			<table class="table" align="center" border="1">
				...
				<c:forEach items="${save_prarentDealer}" var="prarentDealer">
					<tr>
					    <td>${prarentDealer.parentName }</td>
					    <td>${prarentDealer.parentCode }</td>
			...
			<table class="table" align="center" border="1">
				...
				<c:forEach items="${duplicate_prarentDealer}" var="prarentDealer">
					<tr>
					    <td>${prarentDealer.parentName }</td>
					    <td>${prarentDealer.parentCode }</td>
