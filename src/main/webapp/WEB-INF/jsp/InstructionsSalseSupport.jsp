...
<body>
    ...
    <div class="header">
        <div class="container">
            <!-- <div class="logo"><img src="https://staging.irecruit.org.in/sg_irecruit/img/iRecruit-logo.svg" alt="" /></div> -->
    ...
    <ol type="none">
		  ...
		  <li>3.&nbsp; <span> Make sure that your photograph is straightforward with your full face with no background and not with multiple faces in it. Refer to the image below.</span></li>
		   <img src="https://staging.irecruit.org.in/sg_irecruit/img/pimg.png" style="max-width: 100%" />
		  </li>
