...
#searchmspin {
	...
	width: 15px;
	height: 15px;
	background: url('img/search-icn-colored.svg') no-repeat left top;
	z-index: 9;
	cursor: pointer;
	border: none;
...
<body>
	<div class="header">
		<div class="container">
			<div class="logo">
				<h2 class="LOGO"
					style="color: #fff; font-size: 32px; font-weight: 700;">
					<b>iRecruit</b>
				</h2>
			</div>
		</div>
	...
	<div class="container">
		...
		<form action="./reg" class="form" enctype="multipart/form-data"
            ...
            <input type="text" name="firstName" id = "firstName" value ="${name}" onkeypress="return /[0-9a-zA-Z]/i.test(event.key)" disabled />
				...
				<div class="form-block">
					...
					<input type="text" name="firstName" id="firstName"
						placeholder="First Name" value="${candidateFirsName}"
						onkeypress="return /[0-9a-zA-Z]/i.test(event.key)" disabled />
					<!-- <p>Please enter your name</p> -->
				</div>
				<div class="form-block">
					<h5>Last Name</h5>
					<input type="text" name="lastName" id="lastName"
						placeholder="Last Name" value="${CandidateLastName}"
						onkeypress="return /[0-9a-zA-Z]/i.test(event.key)" disabled />
					<!-- <p>Please enter your name</p> -->
				</div>
				<div class="form-block">
				...
				<div class="form-block">
					...
					<input type="text" name="adharNumber" id="adharNumber"
						placeholder="UID/Aadhaar Number" maxlength="12"
						oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
				</div>

				<div class="form-block">
					<h5>Source to know about Dealership</h5>
					<select id="dealership" name="source"
						style="color: black !important">
						<option value="">Select</option>
				...
				<div class="upload-section" id="upload-section-photo"
					...
					<div class="upload-tnc">
						...
						<div id="pp">
							<p>Self-Passport Color Photo (Allowed Photo Size - 3.5 cm x
								4.5 cm)</p>
							<p>File format: JPEG, PNG, JPG and File Size: 500 KB</p>
						</div>
						<!-- in sucess case -->
						<div class="success-tnc" id="successphoto">
							<img src="./img/check-icn.png" /> Successfully uploaded
						</div>
						<!-- in sucess case -->
						<!-- in error case -->
						<div class="error-tnc" id="errorphoto">
							<img src="./img/cross-icn.png" /> Please upload file
						</div>
						<!-- in error case -->
					</div>
					<div class="upload-input">
						...
						<div class="file-upload">
							...
							<input type="file" name="photograph" id="phtograph-input"
								onchange="$(this).parent().find('.file-select-name').html($(this).val().split(/[\\|/]/).pop());"
								style="display: none;" accept=".jpg, .jpeg, .png">
						</div>

						<button class="gray-btn upload-btn" data-id="phtograph-input"
							type="button" onclick="uploadFile('photograph');">Upload</button>
						<a href="images/${participant.photograph}"
							class="gray-btn upload-btn" target="_blank" id="vewphoto"
							style="display: none;">View</a> <img class="preview"
							id="loader_photo" src="./img/loader.gif"
			...
			<div class="form-section">
				<div class="form-block" id="email">
					...
					<input type="email" name="email" placeholder="Email Id"
						value="${participant.email }" disabled />
				</div>
				<div class="form-block">
					<h5>Mobile</h5>
					<input type="text" name="mobile" id="mobile" placeholder="Mobile"
						value="${participant.mobile}" maxlength="10"
						oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
				</div>
				<div class="form-block">
					<h5>State</h5>
					<select name="state" id="state" placeholder="State"
						onchange="getCity()" style="color: black !important">
						<option value="">Select</option>
					</select>
				</div>
				...
				<div class="form-block">
					<h5>City</h5>
					<select name="city" id="cityList" placeholder="City"
						onchange="getPincodeByCity()" style="color: black !important">
						<option value="">Select</option>
					</select>
				</div>
		      ...
		      <datalist id="pincodeList" style="pading:padding-left:10px;">
					...
					<select name="pin" placeholder="Pin Code" id="pincode"
						style="color: black !important">
						<option value="">Select</option>
					</select>
			...
			<div class="form-section">
				<div class="form-block">
					<h5>Two Wheeler</h5>
					<input type="radio" placeholder="Two Wheeler" value="yes"
						id="own_2_yes" name="" onclick="ownTwoYes()" /> <label for="yes">Yes</label>
					<input type="radio" value="no" id="own_2_no" name=""
						onclick="ownTwoN()" /> <label for="no">No</label> <br>
					<div
						style="font-weight: 500; font-size: 12px; font-family: Roboto, sans-serif; display: none; bottom: -28px; color: #f00; margin-top: 5px;"
						id="ownTwoDiv">Please select</div>
				</div>

				<div class="form-block">
					<h5>Four Wheeler</h5>
					<input type="radio" placeholder="Four Wheeler" value="yes"
						id="own_4_yes" name="" onclick="ownFourYes()" /> <label for="yes">Yes</label>
					<input type="radio" value="no" id="own_4_no" name=""
						onclick="ownFourNo()" /> <label for="no">No</label> <br>
					<div
						style="font-weight: 500; font-size: 12px; font-family: Roboto, sans-serif; display: none; bottom: -28px; color: #f00; margin-top: 5px;"
						id="fourTwoDiv">Please select</div>
				</div>
			</div>
			<!--Doyouown/have-->
			...
			<div class="form-section">
				<div class="form-block">
					<h5>Two Wheeler</h5>
					<input type="radio" placeholder="Two Wheeler" value="yes"
						id="driving_2_yes" name="" onclick="drivingTwoYes()" /> <label
						for="yes">Yes</label> <input type="radio" value="no"
						id="driving_2_no" name="" onclick="drivingTwoNo()" /> <label
						for="no">No</label> <br>
					<div
						style="font-weight: 500; font-size: 12px; font-family: Roboto, sans-serif; display: none; bottom: -28px; color: #f00; margin-top: 5px;"
						id="twoWheelerDiv">Please select</div>
				</div>

				<div class="form-block">
					<h5>Four Wheeler</h5>
					<input type="radio" placeholder="Four Wheeler" value="yes"
						id="driving_4_yes" name="" onclick="drivingFourYes()" /> <label
						for="yes">Yes</label> <input type="radio" value="no"
						id="driving_4_no" name="" onclick="drivingFourNo()" /> <label
						for="no">No</label> <br>
					<div
						style="font-weight: 500; font-size: 12px; font-family: Roboto, sans-serif; display: none; bottom: -28px; color: #f00; margin-top: 5px;"
						id="fourWheelerDiv">Please select</div>
				</div>

				<div class="form-block licence-ertifiedd">
					<h5>MDS Certified</h5>
					<input type="radio" placeholder="MDS Certified" value="yes"
						id="certified_yes" name="" onclick="mdsYes()" /> <label for="yes">Yes</label>
					<input type="radio" value="no" id="certified_no" name=""
						onclick="mdsNo()" /> <label for="no">No</label> <br>
					<div
						style="font-weight: 500; font-size: 12px; font-family: Roboto, sans-serif; display: none; bottom: -28px; color: #f00; margin-top: 5px;"
						id="certifiedDiv">Please select</div>
				</div>

				<div class="form-block ">
					<h5>Driving Licence</h5>
					<input type="radio" placeholder="Driving Licence" value="yes"
						id="licence_yes" name="" onclick="dlYes()" /> <label for="yes">Yes</label>
					<input type="radio" value="no" id="licence_no" name=""
						onclick="dlNo()" /> <label for="no">No</label> <br>
					<div
						style="font-weight: 500; font-size: 12px; font-family: Roboto, sans-serif; display: none; bottom: -28px; color: #f00; margin-top: 5px;"
						id="dlDiv">Please select</div>
				</div>
			</div>
			...
			<div class="form-section">
				<div class="form-block">
					...
					<input type="radio" value="fresher" id="fresher" name=""
						onclick="closeExp() " /> <label for="fresher">Fresher</label> <input
						type="radio" value="experience" id="experience" name=""
						onclick="openExp()" /> <label for="experience">Experience</label>
					<br>
					<div
						style="font-weight: 500; font-size: 12px; font-family: Roboto, sans-serif; display: none; bottom: -28px; color: #f00; margin-top: 5px;"
						id="expDiv">Please select</div>
				</div>
				...
				<div class="form-section" style="width: 100% !important;">
					...
					<div class="form-block work-exp">
						...
						<input type="text" name="total"
							placeholder="Total Experience (in months)" maxlength="3"
							id="total" onkeyup="checkTotalExp()"
							oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
					</div>

					<div class="form-block work-exp">
						<h5>Experience in Automobile Industry (in months)</h5>
						<input type="text" name="autoIndustryExperience" maxlength="3"
							placeholder="Experience in Automobile Industry (in months)"
							id="autoIndustryExperience" onkeyup="checkTotalExp()"
							oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
					</div>

					<div class="form-block work-exp">
						<h5>Experience in Non-Automobile Industry (in months)</h5>
						<input type="text" name="nonAutoIndustryExperience"
							placeholder="Experience in Non-Automobile Industry (in months)"
							maxlength="3" id="nonAutoIndustryExperience"
							onkeyup="checkTotalExp()"
							oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
					</div>
				</div>
			...
			<div class="form-section">
				...
				<div class="form-block work-exp">
					...
					<input type="radio" value="yes" id="msilYes" name=""
						onclick="milYes()" /> <label for="yes">Yes</label> <input
						type="radio" value="no" id="msilNo" name="" onclick="milNo()" /> <label
						for="no">No</label> <br>
					<div
						style="font-weight: 500; font-size: 12px; font-family: Roboto, sans-serif; display: none; bottom: -28px; color: #f00; margin-top: 5px;"
						id="msilDiv">Please select</div>
				</div>

				<div class="form-block work-exp" id="old_mspin">
					<h5>MSIL Experience (in months)</h5>
					<input type="text" name="msilExp"
						placeholder="MSIL Experience (in months)" maxlength="8"
						id="mil_exp" onkeyup="checkMSIL()"
						oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
				</div>
				<div class="form-block work-exp" id="old_mspin2">
					<div>
						<h5>MSPIN</h5>
						<input type="text" placeholder="MSPIN" name="oldMspin" id="mspin"
							maxlength="8" onkeyup="deleteOldMSPIN()"
							oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
						<!--<input type="button" value="search" onclick="getOldMSPIN()" id="searchmspin" placeholder="MSPIN">-->
						<div
							style="font-weight: 500; font-size: 12px; font-family: Roboto, sans-serif; display: none; bottom: -28px;"
							id="div_msg"></div>
					</div>
				</div>
			</div>
			<div class="form-section">
				...
				<div class="form-block">
					...
					<select name="primaryLanguage" id="primery_lg"
						style="color: black !important">
						<option value="">Select</option>
				...
				<div class="form-block">
					...
					<select name="secondaryLanguage" id="secondary_lg"
						style="color: black !important">
						<option value="">Select</option>
						<c:forEach items="${language}" var="language">
							<c:choose>
			...
			<div class="upload-section" id="divrmg"
				style="width: 96% !important;">
				<h5 id="rsmm">Upload Your Resume</h5>
				<div class="upload-tnc">
					<div id="pp">
						<p>File format: MS Word and PDF File Size: 500 KB</p>
					</div>
					<!-- in sucess case -->
					<div class="success-tnc" id="successrsm">
						<img src="./img/check-icn.png" /> Successfully uploaded
					</div>
					<!-- in sucess case -->
					<!-- in error case -->
					<div class="error-tnc" id="errorrsm">
						<img src="./img/cross-icn.png" /> Please upload file
					</div>
					<!-- in error case -->
				</div>
				<div class="upload-input">
					...
					<button class="gray-btn upload-btn" data-id="resume-input"
						type="button" onclick="uploadFile8('resume');">Upload</button>
					<a href="images/${participant.resume}" class="gray-btn upload-btn"
						target="_blank" id="vewrsm" style="display: none;">View</a> <img
						class="preview" id="resume_photo" src="./img/loader.gif"
						style="width: 20px; display: none;">
				</div>
			</div>
			<div class="form-btn">
				<input class="btn blue-btn" type="submit" name="req" value="Submit"
					id="submitbtn" /> <input type="hidden" value="" id="temp_fresher"
					name="fresher" /> <input type="hidden" value=""
					id="temp_experience" name="experience" /> <input type="hidden"
					value="" id="age" name="age" /> <input type="hidden" value=""
					id="twoWheeler" name="twoWheeler" /> <input type="hidden" value=""
					id="fourWheeler" name="fourWheeler" /> <input type="hidden"
					value="" id="licence" name="DL" /> <input type="hidden" value=""
					id="certified" name="mdsCertified" /> <input type="hidden"
					value="" id="ownTwoWheeler" name="ownTwoWheeler" /> <input
					type="hidden" value="" id="ownFourWheeler" name="ownFourWheeler" />
				   <input type="hidden" value="" id="msilExp"
					name="workedWithMSILBefore" /> <input path="oldMSPINStatus"
					type="hidden" id="old_mspin_hiden" value="" />
					
					<input type="hidden" value="${participant.finalDesignation}" id="designation" /> 
			</div>
		</form>
	</div>
	<script
