      ...
      function openIterviewForm(key){
           ...
           function funexport()
    	{
           ...
           function search()
       	{
       		...
       		var desg =$('#desg').val();
       		var mspinS =$('#mspinS').val();
       		var passFailStatus =$('#passFail').val();
       		var dateFrom =$('#dateFromm').val();
   		    var dateTo =$('#dateToo').val();
   		    alert(passFailStatus);
       		 document.forms[0].action="./filterParticipantOnFSDMPending?outlet="+outlet+"&candidateName="+name+"&uniqueCode="+uniqueCode+"&designation="+desg+"&mspin="+mspinS+"&passFailStatuss="+passFailStatus+"&dateFromm="+dateFrom+"&dateToo="+dateTo;
       		document.forms[0].method="post";
       		document.forms[0].submit();
       	}
           ...
           function filter()
          	{
          	 	 var prarambh = $('#prarambh').val();
          		 var form = document.createElement("form");
              	
        		 form.method="post";
        		 form.action="./statusPendingApproval?outlet="+outlet+"&candidate="+name+"&unique="+uniqueCode+"&desig="+desg+"&mspinS="+mspinS+"&pass="+passFail+"&dateFromm="+dateFrom+"&dateToo="+dateTo+"&interview="+interview+"&prarambh="+prarambh+"&fsdm="+fsdm;
