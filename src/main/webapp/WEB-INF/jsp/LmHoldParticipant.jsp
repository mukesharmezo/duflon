  ...
  <body>
        ...
        <div class="container-1100">
			...
			<div class="add-remove-columns">
                    ...
                    <ul>
						...
						<li><a class="toggle-vis" data-column="12"><em>Assessment Sheet</em></a></li>
						<li><a class="toggle-vis" data-column="13"><em>Registration Form</em></a></li>
    ...
    <script>
      $(document).ready(function () {
    	  var form = $('#formFilter');
    	  form.attr('action', 'viewAllHoldParticipantLM');
      });
