...
<html lang="en">
  <head>
	...
	<link rel="icon" type="image/x-icon" href="<%=baseServer%>img/iRecruit-favicon.ico"/>    <title>Upload Documents</title>
   ...
   <!--  <script type="text/javascript" src="/js/register.js"></script>  -->
    <script>
        ...
        function uploadFile(fileName,name,success,error,view,div,loader,imgcheck)
        {
        	 ...
        	 var merror = document.getElementById(error);
