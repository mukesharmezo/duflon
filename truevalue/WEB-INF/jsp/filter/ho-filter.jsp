...
<style>
        ...
        .cross-btn {cursor: pointer;border-radius: 5px;margin-bottom: 10px;margin-left: 95%;top: 0;font-size: 20px;background-color: #fff !important;color: #2d3393 !important;border: 1px solid #2d3393 !important;    position: absolute;top: 8px;right: 8px;}
    </style>
...
<div class="page-filters">
    <div class="page-filters-block">
        ...
        <div class="page-filters-filter-block">
            ...
            <form action="hoFilter" method="post"  class="form-section" id="formFilter">
