...
s.setAttribute("fsdm_approvel", "approvel");
...
<html lang="en">
  <head>
    ...
    <style>
        .left-panel > ul > li:nth-child(2) > a, .left-panel > ul > li:nth-child(1) > ul > li:nth-child(2) > a{opacity: 1;}
  ...
  <body>
	...
	<%@include file="./header/user-panel.jsp"%>
		...
		<%@include file="./filter/searchFSDMPending.jsp"%>
	</div>
			...
			<div class="add-remove-columns">
                    ...
                    <ul>
                       ...
                       <!-- <li><a class="toggle-vis" data-column="9"><em>Total Marks</em></a></li>
						...
						<li><a class="toggle-vis" data-column="10"><em>Aptitude</em></a></li> 
						<li><a class="toggle-vis" data-column="11"><em>Attitude</em></a></li> 
						...
						<li><a class="toggle-vis" data-column="14"><em>Data Science</em></a></li>
						...
						<li><a class="toggle-vis" data-column="19"><em>Induction Course Status</em></a></li>
                ...
                <table id="data" cellspacing="0" cellpadding="0" border="0" class="display nowrap cell-border" width="50">
                   <thead>
                        <tr>
							...
							<th data-head="Candidate Name" class="sorting" ><em>Candidate Name</em</span></th>
               ...
               <c:when test="${participant.designation eq 'Sales Support'}">
                           ...
                           <%-- <c:choose>
							...
							<c:choose>
                               ...
                               <span class="red">
							  <div title=" Previously rejected due to:${participant.fsdmReason}">${participant.fsdmApprovalStatus }</div>
							   </span>
                               </c:when>
                                 <c:when test="${participant.fsdmApprovalStatus == 'Pending'}">
								 <c:choose>
                               <c:when test="${participant.fsdmReason != '' }">
      ...
      function openIterviewForm(key){
           ...
           function funexport()
    	{
		    ...
		    var dateTo =$('#dateToo').val();
    		 document.forms[0].action="./getCSVPendingApprovel?outletCode="+outlet+"&candidate="+name+"&unique="+uniqueCode+"&desig="+desg+"&mspinS="+mspinS+"&pass="+passFail+"&dateFromm="+dateFrom+"&dateToo="+dateTo;
