	...
	<%@include file="./header/user-panel.jsp"%>
        ...
        <div class="container-1100">
            <div class="table-date">
                ...
                <table id="data" cellspacing="0" cellpadding="0" border="0" class="stripe display nowrap cell-border" width="50"  style="margin-left: 0px; width: 100%;">
                    <thead>
                        <tr>
