...
<div class="page-filters">
    <div class="page-filters-block">
        <button class="page-filters-filter">Search</button>
        <div class="page-filters-filter-block">
            <form action="filterParticipant" method="post" class="form-section" >
                ...
                <div class="form-block">
                    ...
                    <c:forEach items="${designations}" var="list">
                        <option value="${list.designationName}" <c:if test="${payload.designation eq list.designationName}"> selected</c:if>>${list.designationName}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-block">
                    <input type="text" name="mspin" placeholder="MSPIN" id="mspinS" />
                </div>
                <div class="form-block">
