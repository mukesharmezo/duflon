			...
			<div class="add-remove-columns">
                    ...
                    <ul>
                       ...
                       <!-- <li><a class="toggle-vis" data-column="9"><em>Total Marks</em></a></li>
						...
						<li><a class="toggle-vis" data-column="28"><em>MSPIN</em></a></li>
						<li><a class="toggle-vis" data-column="29"><em>Induction Course Status</em></a></li>
                ...
                <table id="data" cellspacing="0" cellpadding="0" border="0" class="display nowrap cell-border" width="50">
                    <thead>
                        <tr>
                            ...
                            <th data-head="Dealer Name" class="sorting" style="z-index: 1 !important;"><em>Dealer Name</em></th>
