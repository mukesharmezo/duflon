...
{ 
	...
	if(filename.substring((filename.length-5),filename.length)!=".xlsx")
	{
		...
		//document.uploadfile.action="uploadDealerPro";
	    document.uploadfile.action="uploadOutlet";
	...
	<div class="container">
		...
		<div class="table-wrap">
			...
			<table class="table" align="center" border="1">
				...
				<c:forEach items="${save_tdm}" var="tdm">
					<tr>
					    <td>${tdm.mspin }</td>
					    <td>${tdm.name }</td>
						<td>${tdm.email }</td>
			...
			<table class="table" align="center" border="1">
				...
				<c:forEach items="${duplicate_tdm}" var="tdm">
					<tr>
					    <td>${tdm.mspin }</td>
					    <td>${tdm.name }</td>
						<td>${tdm.email }</td>
