  ...
  <body>
    ...
    <div class="user-panel-include">
      <%@include file="./header/user-panel.jsp"%>
        ...
        <%@include file="./filter/ho-filter-hold.jsp" %>
        </div>
        ...
        <div class="container-1100">
			...
			<div class="add-remove-columns">
                    ...
                    <ul>
                        ...
                        <li><a class="toggle-vis" data-column="3"><em>Candidate Name</em></a></li>
						<li><a class="toggle-vis" data-column="4"><em>Profile</em></a></li>
						<li><a class="toggle-vis" data-column="5"><em>Designation Code</em></a></li>
						<li><a class="toggle-vis" data-column="6"><em>Designation Desc</em></a></li>
						<li><a class="toggle-vis" data-column="7"><em>Mobile Number</em></a></li>
						<li><a class="toggle-vis" data-column="8"><em>Access Key</em></a></li>
						<li><a class="toggle-vis" data-column="9"><em>Registration Date</em></a></li>
						<li><a class="toggle-vis" data-column="10"><em>Assessment Date</em></a></li>				
                        <li><a class="toggle-vis" data-column="11"><em>Total Marks</em></a></li>
                        <li><a class="toggle-vis" data-column="12"><em>Marks Obtained</em></a></li>
                        <li><a class="toggle-vis" data-column="13"><em>Percentage</em></a></li>
                        <li><a class="toggle-vis" data-column="14"><em>Assessment Status</em></a></li>
                        <li><a class="toggle-vis" data-column="15"><em>Assessment Report</em></a></li>
						<li><a class="toggle-vis" data-column="16"><em>Assessment Sheet</em></a></li>
                        <li><a class="toggle-vis" data-column="17"><em>Interview Date</em></a></li>
                        <li><a class="toggle-vis" data-column="18"><em>Interview Score</em></a></li>
						<li><a class="toggle-vis" data-column="19"><em>Registration Form</em></a></li>
						<li><a class="toggle-vis" data-column="20"><em>MSPIN</em></a></li>
						<li><a class="toggle-vis" data-column="21"><em>Praarambh Status</em></a></li>
						<li><a class="toggle-vis" data-column="22"><em>Induction Course Status</em></a></li>
						<li><a class="toggle-vis" data-column="23"><em>On-Hold</em></a></li>
			...
			var dealerId = $('#dealerId').val();
 			...
 			var dateTo =$('#dateToo').val();
       		        var form = document.createElement("form");   
       	                form.method="post";
       		        form.action="onHoldHOCSV?regionCode="+regionCode+"&stateCode="+stateCode+"&cityCode="+cityCode+"&parentDealerCode="+parentDealerCode+"&fsdmId="+fsdmId+"&dealerId="+dealerId+"&dateFromm="+dateFrom+"&dateToo="+dateTo;
