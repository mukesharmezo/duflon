                    ...
                    <div class="form-block">
                      <h5>Company Name</h5>
                       <!-- <input type="text" placeholder="Company Name"   id="companyName" name="companyName"/>-->
                        <select id = "companyName" name="companyName" style="color: black !important">
                        <option  value = "">Select</option>
                        ...
                        <option value="MSIL Co-Dealer">MSIL Co-Dealer</option>
                        <option value="any other OEM">any other OEM</option>
          ...
          <div class="form-block">
            <h5>Company Name</h5>
              <!--<input type="text" value=""  placeholder="Company Name"  id="ed_companyName"/> -->
               <select id = "ed_companyName" name="companyName" style="color: black !important">
                        <option  value = "">Select</option>
                        <option value="Hyundai">Hyundai</option>
                        <option value="Tata">Tata</option>
                        <option value="Kia">Kia</option>
